...
using CoH.Content.Items.Weapons.Summon.Desert;
...
namespace CoH.Content.Projectiles.Summon.Desert
{
	public class RuggedCarpetProjectile : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
			target.AddBuff(ModContent.BuffType<RuggedCarpetDebuff>(), 240);
			target.AddBuff(ModContent.BuffType<Blinded>(), 420);
			Main.player[Projectile.owner].MinionAttackTargetNPC = target.whoAmI;
			Projectile.damage = (int)(Projectile.damage * 0.25f); // Multihit penalty. Decrease the damage the more enemies the whip hits.
